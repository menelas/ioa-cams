...
(function() {
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.keydown_backstroke = function() {
      ...
      if (this.Draft_backstroke) {
        this.choice_destroy(this.Draft_backstroke.down("a"));
        return this.clear_backstroke();
      } else {
        next_available_destroy = this.search_container.siblings().last();
        if (next_available_destroy && next_available_destroy.hasClassName("search-choice") && !next_available_destroy.hasClassName("search-choice-disabled")) {
          this.Draft_backstroke = next_available_destroy;
          if (this.Draft_backstroke) {
            this.Draft_backstroke.addClassName("search-choice-focus");
          }
          if (this.single_backstroke_delete) {
            return this.keydown_backstroke();
          } else {
            return this.Draft_backstroke.addClassName("search-choice-focus");
          }
        }
      }
    };
    ...
    Chosen.prototype.clear_backstroke = function() {
      if (this.Draft_backstroke) {
        this.Draft_backstroke.removeClassName("search-choice-focus");
      }
      return this.Draft_backstroke = null;
    };
    ...
    Chosen.prototype.keydown_checker = function(evt) {
      ...
      this.search_field_scale();
      if (stroke !== 8 && this.Draft_backstroke) {
        this.clear_backstroke();
      }
      switch (stroke) {
        case 8:
